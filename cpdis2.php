...
$s=$_GET['stfid'];
$c=$_GET['cc'];
$productResult = $db_handle->runQuery("select Staff_name,Sem,Course,Course_code,Year from Staff where Staff_id='$s' and Course_code='$c'");
...
$s=$_GET['stfid'];
$c=$_GET['cc'];
$productResult2= $db_handle->runQuery("select Unit_no,Title_name,Subdivision,Date_planned,Hours,Methodology,Learning_outcomes_achieved from ct where Staff_id='$s' and Course_code='$c'");
if(!
$productResult2){
echo "<script> alert('Record Not Found, Plz Check Your Staff Id or Course Code'); </script>";
echo "<script> location.href='cpln2.php'; </script>";
}
...
<th>Unit No</th><th>Title Name</th><th>Subdivision</th><th>Date Planned</th><th>Hours</th><th>Methodology For Evaluate</th><th>Learning Outcome</th>
                </tr>
            </thead>
            <tbody>
