...
<label for="Title_name" class="control-label">Title Name:</label>
...
<label for="Date_planned" class="control-label">Date Planned:</label>
...
<label for="Date_complition" class="control-label">Date Complition:</label>
...
<label for="Learning_outcome" class="control-label">Learning Outcome:</label>
...
$('#edit_Unit_no').val(ele.siblings(':nth-of-type(2)').html());

$('#edit_Title_name').val(ele.siblings(':nth-of-type(3)').html());

$('#edit_Subdivision').val(ele.siblings(':nth-of-type(4)').html());

$('#edit_Date_planned').val(ele.siblings(':nth-of-type(5)').html());

$('#edit_Hours').val(ele.siblings(':nth-of-type(6)').html());

$('#edit_Date_complition').val(ele.siblings(':nth-of-type(7)').html());
                               
$('#edit_Methodolagy').val(ele.siblings(':nth-of-type(8)').html());
                               
 $('#edit_Learning_outcome').val(ele.siblings(':nth-of-type(9)').html());
						} else {
...
var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					alert(conf);
                    if(conf){
                                $.post(' responsea.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
