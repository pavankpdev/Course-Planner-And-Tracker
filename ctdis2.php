...
$s=$_GET['stfid'];
$c=$_GET['cc'];
$productResult2= $db_handle->runQuery("select Unit_no,Title_name,Subdivision,Date_planned,Hours,Date_complition,Methodology,Learning_outcomes_achieved from ct where Staff_id='$s' and Course_code='$c'");
if(!
$productResult2){
echo "<script> alert('Record Not Found, Plz Check Your Staff Id or Course Code'); </script>";
echo "<script> location.href='ctrkr2.php'; </script>";
}
