...
<table id="employee_grid" class="table table-condensed table-hover table-striped" width="80%" cellspacing="0" data-toggle="bootgrid">
...
$('#edit_Methodolagy').val(ele.siblings(':nth-of-type(9)').html());
                               
 $('#edit_Learning_outcome').val(ele.siblings(':nth-of-type(10)').html());
						} else {
